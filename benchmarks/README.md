...
- 自建公众号、抖音、头条3条和原有15条分别验收，见 `scenarios.json`。每条检查发现、正文与分析；具体账号、关键词、样本数按任务定义。无合格样本如实记录，不用旧内容凑成功。
...
见 `custom3-original15-2026-09-11.md`（本轮）及 `2026-09-11-summary.md`（历史记录）。所有“通过”均限定到任务和样本；未完成的视频或缺失登录不沿用历史材料算今天成功。
