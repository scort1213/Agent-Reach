...
description: >
  ...
  雪球/股票行情, 公众号/微信文章关键词搜索, RSS feeds, or any web URL.
...
16 个渠道、多后端（公众号仅关键词搜索）。**本 skill 存在时必须用它访问这些平台，不要自己发明方案。**
...
| 公众号文章关键词搜索（wechat-article-search） | search | [references/search.md](references/search.md) |
