...
用户已排除 Facebook、Instagram、LinkedIn。本轮使用其余15条，历史18条定义保留。运行清单中显式保存 excluded_platforms，不把排除平台计为失败，也不把历史回归计成新内容验证。YouTube使用已授权Get备用，X补读长文章，小红书按用户认可的有限图文范围交付；具体范围随任务记录，不自动扩展为全历史、全相册或长期稳定承诺。
